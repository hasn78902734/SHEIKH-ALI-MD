...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "AS0kzLwa#gkp5heUAKSrk8H47eceR3BFSy6wviiVkk1Ibyw7k6-8",
    ...
    STATUS_REPLY: process.env.STATUS_REPLY || "`➺үσυя sтαтυs sεεη נυsт ησω вү ☞ 𒁂𓄂𝑺𝑯𝑬𝑰𝑲𝑯 𝑨𝑳𝑰 𝑨𝑯𝑴𝑨𝑫🔥༽༼гՇ࿐𒁂`",
