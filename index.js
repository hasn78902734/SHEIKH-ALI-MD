...
console.log('⇝𝐻𝒶𝓈𝓈𝒶𝓃 ʀᴀᴊᴘ𝙾𝙾ᴛ- MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `
*[ •  ⇝𝐻𝒶𝓈𝓈𝒶𝓃 ʀᴀᴊᴘ𝙾𝙾ᴛ ×͜×- MD - STARTED‎ • ]*
*╭┈───────────────•*
...
*│  ◦*
*│  ◦* *https://youtube.com/@hassangaming425?si=-oRMW560FMyVb1RL*
*╰┈───────────────•*
*[ •  B O T  - R E P O ‎ • ]*
*╭┈───────────────•*
*│✫➠ - 🌐URL:* *https://github.com/Hasn77392/Hassan_Rajpoot_MD.git*
*╰┈───────────────•*
...
app.get("/", (req, res) => {
res.send("HEY, ⇝𝐻𝒶𝓈𝓈𝒶𝓃 ʀᴀᴊᴘ𝙾𝙾ᴛ- MD STARTED ✅");
});
